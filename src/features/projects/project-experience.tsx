        ...
        {project.status === "completed" || project.status === "approved" ? (
          <div className={styles.resultLayout}>
            ...
            <aside className={styles.reviewPanel}>
              <p className={styles.eyebrow}>Campaign result</p><h2>Review the direction.</h2><p>{project.generationResult?.provider === "replicate" ? "This image was generated by Nano Banana 2 through the server-only Replicate provider route." : project.generationResult?.provider === "gemini" ? "This image was generated by Gemini through the server-only provider route." : "This image completed the same validated server flow using the no-charge mock provider."}</p>
